...
C         Write(*,*) "ENTER ERD__SET_IJ_KL_PAIRS"
...
C         Write(*,*) "The number of grid pts", NGQP
C         Write(*,*) "ENTER ERD__E0F0_DEF_DSHIELD_BLOCKS"
...
C         Write(*,*) "END ERD__E0F0_DEF_DSHIELD_BLOCKS"
