...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_DSHIELDZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_DSHIELDZZ_PQ_INTEGRALS
...
C------------------------------------------------------------------------
C
C         Write(*,*) "ERD__2D_ATOM_DSHIELDZZ_PQ_INTEGRALS"
         N = 0
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                 ...
                 INT2DZ1 (N,0,0) = - QKL  * INT2DZ (N,0,0)

                 DO K = 1, SHELLQ
                    K1 = K + 1
                    INT2DX1 (N,0,K) = INT2DX (N,0,K) * QROOT
                    INT2DY1 (N,0,K) = INT2DY (N,0,K)
                    INT2DZ1 (N,0,K) = - QKL * INT2DZ (N,0,K) * K1
                 ENDDO
                 ...
                 DO I = 1, SHELLP
                    ...
                    INT2DZ1 (N,I,0) = PIJ * INT2DZ (N,I1,1) * I -
     +                                QKL * INT2DZ (N,I,0)
                 ENDDO
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DZ1 (N,I,K) = INT2DZ (N,I1,K1) * I  * PIJ  -
     +                                   INT2DZ (N,I,K)   * K1 * QKL
                     ENDDO
                 ENDDO
