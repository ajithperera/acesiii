...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_DSHIELDZX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_DSHIELDZX_PQ_INTEGRALS
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                 ...
                 DO K = 1, SHELLQ
                    ...
                    INT2DZ1 (N,0,K) =-INT2DZ (N,0,K1) * QKL * K
                 ENDDO
                 ...
                 DO I = 1, SHELLP
                    ...
                    INT2DZ1 (N,I,0) = INT2DZ (N,I1,0) * PIJ * I
                 ENDDO
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DZ1 (N,I,K) = INT2DZ (N,I1,K) * I * PIJ  -
     +                                   INT2DZ (N,I,K1) * K * QKL
                     ENDDO
                 ENDDO
