...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_DSHIELDYY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_DSHIELDYY_PQ_INTEGRALS
...
C
         ...
         DOUBLE PRECISION  PQYC,PIJYC,QKLYC
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DX1 (N,0,0) = INT2DX (N,0,0)
                  INT2DY1 (N,0,0) = PQY  * INT2DY (N,0,1) -
     +                              QKL  * INT2DY (N,0,0) +
     +                              PQYC * INT2DY (N,0,0)
                  ...
                  DO K = 1, SHELLQ
                     K1 = K - 1
                     K2 = K + 1
                     INT2DX1 (N,0,K) = INT2DX (N,0,K)
                     INT2DY1 (N,0,K) = PQY  * INT2DY (N,0,K2) -
     +                                 QKL  * INT2DY (N,0,K)  * K2 + 
     +                                 PQYC * INT2DY (N,0,K)  -
     +                                 QKL  * INT2DY (N,0,K1) * YC *
     +                                 K 
                  ...
                  DO I = 1, SHELLP
                     I1 = I -1 
                     INT2DX1 (N,I,0) = INT2DX (N,I,0)
                     INT2DY1 (N,I,0) = PQY  * INT2DY (N,I,1)  +
     +                                 PIJ  * INT2DY (N,I1,1) * I -
     +                                 QKL  * INT2DY (N,I,0)  +
     +                                 PQYC * INT2DY (N,I,0)  +
     +                                 PIJ  * INT2DY (N,I1,0) * YC *
     +                                 I
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        ...
                        INT2DX1 (N,I,K) = INT2DX (N,I,K)
                        INT2DY1 (N,I,K) = PQY  * INT2DY (N,I,K1)  +
     +                                    PIJ  * INT2DY (N,I1,K1) * I  -
     +                                    QKL  * INT2DY (N,I,K)   * K1 +
     +                                    PQYC * INT2DY (N,I,K)   +
     +                                    PIJ  * INT2DY (N,I1,K)  *
     +                                    YC   * I                -
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
                  ...
                  INT2DX1 (N,0,0) = INT2DX (N,0,0)
                  INT2DX1 (N,0,1) = INT2DX (N,0,1)
                  INT2DY1 (N,0,0) = PQY   * INT2DY (N,0,1) -
     +                              QKL   * INT2DY (N,0,0) +
     +                              PQYC  * INT2DY (N,0,0)
                  INT2DY1 (N,0,1) = PQY   * INT2DY (N,0,2) -
     +                              QKL2  * INT2DY (N,0,1) +
     +                              PQYC  * INT2DY (N,0,1) -
     +                              QKLYC * INT2DY (N,0,0)
                  INT2DZ1 (N,0,0) = INT2DZ (N,0,0) * QROOT
                 ...
                 DO K = 2, SHELLQ
                     ...
                     INT2DX1 (N,0,K) = INT2DX (N,0,K)
                     INT2DY1 (N,0,K) = PQY   *      INT2DY (N,0,K1)  -
     +                                 QKL   * K1 * INT2DY (N,0,K)   +
     +                                 PQYC  *      INT2DY (N,0,K)   -
     +                                 QKLYC * K  * INT2DY (N,0,K2) 
                     INT2DZ1 (N,0,K) = INT2DZ (N,0,K) * QROOT 
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
                  ...
                  INT2DX1 (N,0,0) = INT2DX (N,0,0)
                  INT2DX1 (N,1,0) = INT2DX (N,1,0)
                  INT2DY1 (N,0,0) = PQY   * INT2DY (N,0,1) -
     +                              QKL   * INT2DY (N,0,0) +
     +                              PQYC  * INT2DY (N,0,0)
                  INT2DY1 (N,1,0) = PQY   * INT2DY (N,1,1) +
     +                              PIJ   * INT2DY (N,0,1) -
     +                              QKL   * INT2DY (N,1,0) +
     +                              PQYC  * INT2DY (N,1,0) +
     +                              PIJYC * INT2DY (N,0,0) 
