...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_DSHIELDXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DX1 (N,0,0) = PQX  * INT2DX (N,0,1) -
     +                              QKL  * INT2DX (N,0,0) +
     +                              PQXC * INT2DX (N,0,0)
                  INT2DY1 (N,0,0) = INT2DY (N,0,0)
                  INT2DZ1 (N,0,0) = INT2DZ (N,0,0) * QROOT

                  DO K = 1, SHELLQ
                     K1 = K - 1
                     K2 = K + 1
                     INT2DX1 (N,0,K) = PQX  * INT2DX (N,0,K2) -
     +                                 QKL  * INT2DX (N,0,K)  * K2 +
     +                                 PQXC * INT2DX (N,0,K)  -
     +                                 QKL  * INT2DX (N,0,K1) * XC *
     +                                 K
                     INT2DY1 (N,0,K) = INT2DY (N,0,K)
                     INT2DZ1 (N,0,K) = INT2DZ (N,0,K) * QROOT
                  ENDDO
 
                  DO I = 1, SHELLP
                     I1 = I - 1
                     INT2DX1 (N,I,0) = PQX  * INT2DX (N,I,1)  +
     +                                 PIJ  * INT2DX (N,I1,1) * I -
     +                                 QKL  * INT2DX (N,I,0)  +
     +                                 PQXC * INT2DX (N,I,0)  +
     +                                 PIJ  * INT2DX (N,I1,0) * XC *
     +                                 I 
                    INT2DY1 (N,I,0) = INT2DY (N,I,0)
                  ...
                  DO I = 1,  SHELLP 
                     DO K = 1,  SHELLQ
                        ...
                        INT2DX1 (N,I,K) = PQX  * INT2DX (N,I,K2)  +
     +                                    PIJ  * INT2DX (N,I1,K2) * I  -
     +                                    QKL  * INT2DX (N,I,K)   * K2 +
     +                                    PQXC * INT2DX (N,I,K)   +
     +                                    PIJ  * INT2DX (N,I1,K)  *
     +                                    XC   * I                -
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
     ...
     +                              QKL   * INT2DX (N,0,0) +
     +                              PQXC  * INT2DX (N,0,0)
                  INT2DX1 (N,0,1) = PQX   * INT2DX (N,0,2) -
     +                              QKL2  * INT2DX (N,0,1) +
     +                              PQXC  * INT2DX (N,0,1) -
     +                              QKLXC * INT2DX (N,0,0)

                  INT2DY1 (N,0,0) = INT2DY (N,0,0)
                  INT2DY1 (N,0,1) = INT2DY (N,0,1)
                 ...
                 DO K = 2, SHELLQ
                     ...
                     INT2DX1 (N,0,K) = PQX   *      INT2DX (N,0,K1)  -
     +                                 QKL   * K1 * INT2DX (N,0,K)   +
     +                                 PQXC  *      INT2DX (N,0,K)   -
     +                                 QKLXC * K  * INT2DX (N,0,K2) 
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
     ...
     +                              QKL   * INT2DX (N,0,0) +
     +                              PQXC  * INT2DX (N,0,0)
                  INT2DX1 (N,1,0) = PQX   * INT2DX (N,1,1) +
     +                              PIJ   * INT2DX (N,0,1) -
     +                              QKL   * INT2DX (N,1,0) +
     +                              PQXC  * INT2DX (N,1,0) +
     +                              PIJXC * INT2DX (N,0,0) 
