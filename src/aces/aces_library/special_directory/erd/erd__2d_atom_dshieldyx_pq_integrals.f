...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_DSHIELDYX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_DSHIELDYX_PQ_INTEGRALS
...
C         Write(*,*) "In ERD__2D_ATOM_DSHIELDYX_PQ_INTEGRALS"
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                 ...
                 DO K = 1, SHELLQ
                    ...
                    INT2DX1 (N,0,K) =  INT2DX (N,0,K2)
                    INT2DY1 (N,0,K) =- INT2DY (N,0,K1) * QKL * K
                 ...
                 DO I  = 1, SHELLP
                    ...
                    INT2DY1 (N,I,0) = INT2DY (N,I1,0) * PIJ * I
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DX1 (N,I,K) = INT2DX (N,I,K2)
                       INT2DY1 (N,I,K) = INT2DY (N,I1,K) * I * PIJ  -
     +                                   INT2DY (N,I,K1) * K * QKL
