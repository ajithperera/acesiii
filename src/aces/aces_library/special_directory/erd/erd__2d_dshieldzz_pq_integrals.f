...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_DSHIELDZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_DSHIELDZZ_PQ_INTEGRALS
...
C
         ...
         DOUBLE PRECISION  PQZC,PIJZC,QKLZC
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DZ1 (N,0,0) = PQZ  * INT2DZ (N,0,1) -
     +                              QKL  * INT2DZ (N,0,0) +
     +                              PQZC * INT2DZ (N,0,0)
                  ...
                  DO K = 1, SHELLQ
                     ...
                     INT2DZ1 (N,0,K) = PQZ  * INT2DZ (N,0,K2) -
     +                                 QKL  * INT2DZ (N,0,K)  * K2  +
     +                                 PQZC * INT2DZ (N,0,K)  -
     +                                 QKL  * INT2DZ (N,0,K1) * ZC *
     +                                 K 
                  ENDDO 
                  ...
                  DO I = 1, SHELLP
                     ...
                     INT2DZ1 (N,I,0) = PQZ  * INT2DZ (N,I,1)  +
     +                                 PIJ  * INT2DZ (N,I1,1) * I -
     +                                 QKL  * INT2DZ (N,I,0)  +
     +                                 PQZC * INT2DZ (N,I,0)  +
     +                                 PIJ  * INT2DZ (N,I1,0) * ZC * 
     +                                 I 
                  ENDDO
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        ...
                        INT2DZ1 (N,I,K) = PQZ  * INT2DZ (N,I,K1)  +
     +                                    PIJ  * INT2DZ (N,I1,K1) * I  -
     +                                    QKL  * INT2DZ (N,I,K)   * K1 +
     +                                    PQZC * INT2DZ (N,I,K)   +
     +                                    PIJ  * INT2DZ (N,I1,K)  *
     +                                    ZC   * I                -
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
     ...
     +                              PQZC  * INT2DZ (N,0,0)
                  ...
                  INT2DZ1 (N,0,1) = PQZ   * INT2DZ (N,0,2) -
     +                              QKL2  * INT2DZ (N,0,1) +
     +                              PQZC  * INT2DZ (N,0,1) -
     +                              QKLZC * INT2DZ (N,0,0)
                 ...
                 DO K = 2, SHELLQ
                     ...
                     INT2DZ1 (N,0,K) = PQZ   *      INT2DZ (N,0,K1)  -
     +                                 QKL   * K1 * INT2DZ (N,0,K)   +
     +                                 PQZC  *      INT2DZ (N,0,K)   -
     +                                 QKLZC * K  * INT2DZ (N,0,K2) 
                 ENDDO
...
CSSS                  QROOT = RTS(N) * (1.0D0 - RTS(N)) * TWORHO
     ...
     +                              QKL   * INT2DZ (N,0,0) +
     +                              PQZC  * INT2DZ (N,0,0)
                  INT2DZ1 (N,1,0) = PQZ   * INT2DZ (N,1,1) +
     +                              PIJ   * INT2DZ (N,0,1) -
     +                              QKL   * INT2DZ (N,1,0) +
     +                              PQZC  * INT2DZ (N,1,0) +
     +                              PIJZC * INT2DZ (N,0,0) 
