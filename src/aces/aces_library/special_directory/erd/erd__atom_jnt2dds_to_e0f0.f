...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__ATOM_JNT2DDS_TO_E0F0
     +
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__ATOM_JNT2DDS_TO_E0F0
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 102
               ...
               DO 110 YF = 0,YFEND
                  ...
                  DO 112 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 112
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 202
               ...
               DO 210 YF = 0,YFEND
                  ...
                  DO 212 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 212
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 302
               ...
               DO 310 YF = 0,YFEND
                  ...
                  DO 312 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 312
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 402
               ...
               DO 410 YF = 0,YFEND
                  ...
                  DO 412 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 412
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 502
               ...
               DO 510 YF = 0,YFEND
                  ...
                  DO 512 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 512
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 602
               ...
               DO 610 YF = 0,YFEND
                  ...
                  DO 612 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 612
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 702
               ...
               DO 710 YF = 0,YFEND
                  ...
                  DO 712 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 712
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 802
               ...
               DO 810 YF = 0,YFEND
                  ...
                  DO 812 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 812
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 902
               ...
               DO 910 YF = 0,YFEND
                  ...
                  DO 912 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 912
...
CSSS               IF (MOD (XE+XF,2).EQ.1) GOTO 1002
...
C
               ...
               DO 1010 YF = 0,YFEND
                  ...
                  DO 1012 YE = 0,YEEND
                     ...
                     YTOT = YE + YF
CSSS                     IF (MOD (YTOT,2).EQ.1) GOTO 1012
