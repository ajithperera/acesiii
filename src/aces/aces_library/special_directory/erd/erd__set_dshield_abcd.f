...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__SET_DSHIELD_ABCD
     +
...
C
C The same conditions apply for regular two particle repulsion integrals
C do not apply for two  particle diamagnetic integrals.
C 
...
C         WRITE(*,*) "CASE 1 =", CASE1
C         WRITE(*,*) "CASE 2 =", CASE2
