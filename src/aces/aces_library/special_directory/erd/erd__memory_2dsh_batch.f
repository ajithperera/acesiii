...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__MEMORY_2DSH_BATCH
     +
     +                    ( NALPHA,NCOEFF,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__MEMORY_DSH_BATCH
C  MODULE      : ELECTRON REPULSION INTEGRALS DIRECT
C  MODULE-ID   : ERD
C  SUBROUTINES : ERD__MEMORY_1111_2DSH__CSGTO
C                ERD__MEMORY_2DSH_CSGTO
...
C
         IF (MAX0(SHELL1,SHELL2,SHELL3,SHELL4).LT.2) THEN
             ...
             CALL  ERD__MEMORY_1111_2DSH_CSGTO
     +
     +                  ( NALPHA,NCOEFF,
     +                    NCGTO1,NCGTO2,NCGTO3,NCGTO4,
     +                    NPGTO1,NPGTO2,NPGTO3,NPGTO4,
