...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_DSHIELDXY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_DSHIELDXY_PQ_INTEGRALS
...
C         Write(*,*) "In ERD__2D_ATOM_DSHIELDXY_PQ_INTEGRALS"
