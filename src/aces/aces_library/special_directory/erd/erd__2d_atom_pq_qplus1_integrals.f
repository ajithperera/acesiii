...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_PQ_QPLUS1_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      NGQEXQ,
     +                      WTS,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_PQ_QPLUS1_INTEGRALS
