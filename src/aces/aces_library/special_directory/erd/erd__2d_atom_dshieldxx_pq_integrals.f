...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_DSHIELDXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_DSHIELDXX_PQ_INTEGRALS
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                 ...
                 INT2DX1 (N,0,0) = - QKL * INT2DX (N,0,0) 
                 INT2DY1 (N,0,0) = INT2DY (N,0,0)
                 INT2DZ1 (N,0,0) = INT2DZ (N,0,0) * QROOT

                 DO K = 1, SHELLQ
                    K1 = K + 1
                    INT2DX1 (N,0,K) = - QKL * INT2DX (N,0,K) * K1
                 ...
                 DO I = 1, SHELLP
                    I1 = I - 1
                    INT2DX1 (N,I,0) = PIJ * INT2DX (N,I1,1) * I -
     +                                QKL * INT2DX (N,I,0)
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DX1 (N,I,K) = INT2DX (N,I1,K2) * I  * PIJ  -
     +                                   INT2DX (N,I,K)   * K2 * QKL
